...
// The code implements a singly linked list with various operations such as insertion, deletion, and searching.
// The code is structured with a Node class representing each node in the list and a LIST class managing the linked list operations.
// The code includes functions to push elements to the front and back of the list, pop elements from the front and back, insert elements at a specific position, and search for elements by value or index.
    ...
    public:
        ...
        void searchbyvalue(int val){ // Function to search for a value in the linked list
            ...
            while ( temp != NULL){ // While there are nodes to traverse
                ...
                cout << "value found at index " << index << endl;  // If the value is found, print the index
         ...
         cout << "given value "<< val  << " is not found the list" << endl;
         return; // Return from the function
    }
        void searchbyindex(int index){  
            // function is to search for a valuse based on the index 
            if (head == NULL) { // Check if the list is empty
                cout << "List is empty, nothing to search." << endl; // If the list is empty, print a message
                return;
            }
